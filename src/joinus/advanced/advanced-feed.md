...
To update the documentation for your route with support for podcast feeds, you'll need to set the `supportPodcast` attribute of `features` in the `Route` export object to `true`. Here's an example:
