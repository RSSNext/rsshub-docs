...
<Route namespace="bakamh" :data='{"path":"/manga/:name","categories":["anime"],"example":"/bakamh/manga/最强家丁","parameters":{"name":"漫画名称，漫画主页的地址栏中"},"radar":[{"source":["bakamh.com/manga/:name/"]}],"name":"漫画更新","maintainers":["yoyobase"],"url":"bakamh.com","location":"manga.ts"}' :test='undefined' />
