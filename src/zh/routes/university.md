...
<Route namespace="stbu" :data='{"path":"/xyxw","categories":["university"],"example":"/stbu/xyxw","parameters":{},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":true,"supportBT":false,"supportPodcast":false,"supportScihub":false},"radar":[{"source":["stbu.edu.cn/html/news/xueyuan","stbu.edu.cn"]}],"name":"学院新闻","maintainers":["HyperCherry"],"url":"stbu.edu.cn/html/news/xueyuan","location":"xyxw.ts"}' :test='undefined' />
