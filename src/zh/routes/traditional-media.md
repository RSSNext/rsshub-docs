...
<Route namespace="gq" :data='{"path":"/news","categories":["traditional-media"],"view":0,"example":"/gq/news","parameters":{},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"radar":[{"source":["gq.com/"]}],"name":"News","maintainers":["EthanWng97"],"location":"news.ts","heat":551,"topFeeds":[{"id":"57995444932781056","type":"feed","url":"rsshub://gq/news","title":"GQ","description":"GQ is the global flagship of men&#39;s fashion, the arbiter of cool for anyone who sees the world through the lens of taste and style. - Powered by RSSHub","image":null}]}' :test='{"code":0}' />
