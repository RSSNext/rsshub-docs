...
## Always Control <Site url="alwayscontrol.com.cn"/>

### 最新动态 <Site url="alwayscontrol.com.cn" size="sm" />

<Route namespace="alwayscontrol" :data='{"path":"/news","categories":["other"],"example":"/alwayscontrol/news","features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"name":"最新动态","maintainers":["moss-xxh"],"url":"alwayscontrol.com.cn","radar":[{"source":["www.alwayscontrol.com.cn/zh-CN/news/list"],"target":"/news"}],"description":"Always Control（旭衡电子）智能能源管理系统解决方案专家的最新动态","location":"news.ts","heat":0,"topFeeds":[]}' :test='undefined' />
