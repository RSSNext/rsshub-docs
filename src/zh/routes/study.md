...
<Route namespace="neea" :data='{"path":"/global/jlpt","name":"日本语能力测试(JLPT)通知","url":"jlpt.neea.edu.cn","maintainers":["nczitzk"],"example":"/neea/global/jlpt","parameters":{},"categories":["study"],"features":{"supportRadar":true},"radar":[{"source":["jlpt.neea.edu.cn","jlpt.neea.cn"],"target":"/global/jlpt"}],"location":"jlpt.ts"}' :test='undefined' />
