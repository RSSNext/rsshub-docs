...
<Route namespace="yahoo" :data='{"path":"/news/providers/:region/list","categories":["new-media"],"example":"/yahoo/news/providers/tw/list","parameters":{"region":"地区, 同路由\"新闻来源\"中的支持地区, 即 hk 或 tw"},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"radar":[{"source":["hk.news.yahoo.com/","tw.news.yahoo.com/"]}],"name":"新聞來源列表","maintainers":["TonyRL","williamgateszhao"],"location":"news/provider-helper.ts"}' :test='{"code":1,"message":"Test timed out in 10000ms.\nIf this is a long-running test, pass a timeout value as the last argument or configure it globally with \"testTimeout\"."}' />
