...
<Route namespace="aiblog-2xv" :data='{"path":"/archives","categories":["blog"],"example":"/aiblog-2xv/archives","parameters":{},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"radar":[{"source":["aiblog-2xv.pages.dev/archives"],"target":"/archives"}],"name":"归档-全部文章","maintainers":["Liao-Ke"],"location":"archives.ts","heat":0,"topFeeds":[]}' :test='{"code":0}' />
