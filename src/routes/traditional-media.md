...
<Route namespace="yicai" :data='{"path":"/headline","categories":["traditional-media"],"example":"/yicai/headline","parameters":{},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"radar":[{"source":["yicai.com/"]}],"name":"头条","maintainers":["nczitzk"],"url":"yicai.com/","location":"headline.ts","heat":644,"topFeeds":[{"id":"54806809341165585","type":"feed","url":"rsshub://yicai/headline","title":"第一财经 - 头条","description":"第一财经 - 头条 - Powered by RSSHub","image":null}]}' :test='{"code":0}' />
