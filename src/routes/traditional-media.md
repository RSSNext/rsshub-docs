...
<Route namespace="bjnews" :data='{"path":"/cat/:cat","categories":["traditional-media"],"example":"/bjnews/cat/depth","parameters":{"cat":"分类, 可从URL中找到"},"features":{},"radar":[{"source":["www.bjnews.com.cn/:cat"]}],"name":"分类","maintainers":["dzx-dzx"],"url":"www.bjnews.com.cn","location":"cat.ts"}' :test='{"code":1,"message":"Error: Test timed out in 60000ms.\nIf this is a long-running test, pass a timeout value as the last argument or configure it globally with \"testTimeout\".\n    at Timeout.<anonymous> (file:///home/runner/work/RSSHub/RSSHub/node_modules/.pnpm/@vitest+runner@2.0.5/node_modules/@vitest/runner/dist/index.js:66:18)\n    at listOnTimeout (node:internal/timers:581:17)\n    at processTimers (node:internal/timers:519:7)"}' />
